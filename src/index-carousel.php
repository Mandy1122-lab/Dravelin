                    ...
                    <div class="blog__details__form">
                        ...
                        <div style="flex: 1; margin-top: 10px;">
                            <h6 class="text-size">選擇連結之&nbsp;
                                <input type='radio' name='category' value='spot' style="vertical-align: middle;">&nbsp;景點(spot-info.php?s_id=) /
                            ...
                            <form id="searchForm" class="header__search__form">
                                <input type="text" name="search" placeholder="搜尋景點/活動" style="border: 1px solid #1D50A1; width:150px; height:30px;background-color: #E0E0E0;">
                            ...
                            <table data-toolbar="#toolbar" class="table bg-light table-striped" data-toggle="table" data-sortable="true" data-sort-class="table-active" data-pagination="true" data-search="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="name" data-sortable="true" style="width:60%;">景點/活動名稱</th>
                                        <th data-field="link" data-sortable="true" style="width:30%;">景點/活動連結</th>
                                    </tr>
                                </thead>
