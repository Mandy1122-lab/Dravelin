...
<body>
    ...
    <section id="content">
        ...
        <h5><span class="bold-text">編輯 - 小專區3</span></h5>
        <hr>
        <!-- Input Fields -->
        <script>
        ...
        $result = mysqli_query($link, "SELECT * FROM area WHERE area_id = 3"); // 根據“小專區3”的ID查詢記錄
        ...
        <form id="updateArea">
            ...
            <input type="hidden" name="area_id" value="3"> <!-- 這裡將其設置為3表示“小專區3” -->
