                            ...
                            <div class="tab-pane fade show active" id="introduce" role="tabpanel" aria-labelledby="introduce-tab">
                                <form action="./dblinks/dblink-movie.php" method="post">
                                    ...
                                    <table class="table" frame=void style="table-layout:fixed">
                                        <tr>
                                            <td><p>電影名稱</p><input type=text name="m_name" placeholder="作品名" required maxlength=100></td>
                                            <td rowspan="2"><p>劇情簡介</p><textarea name="m_intro" placeholder="簡介內容" rows="8" cols="60" required maxlength=900></textarea></td>
                                        </tr>
                                        <tr>
                                            <td><p>日期</p><input type="date" id="start" name="m_date" required></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p>國家</p>
                                            ...
                                            <td><p>封面圖片</p><input type="url" name="m_pic" placeholder="圖片網址" required maxlength=300></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <?php
