...
<body>
    ...
    <?php
        $l_id=$_GET['l_id'];
        $sql = "select * from listmovie where l_id = '$l_id'";
                ...
                <div class="col-lg-12">
                    ...
                    <?php echo "
                        <table width='100%'>
                            <tr><td><h3>編輯 :  $l_name</h3></td>
                                <td align=right>
                                <a href='javascript:void(0);' onclick='confirmDelete(\"./dblinks/delete-movieListAll.php?method=delete&l_id={$l_id}\")'><button class='btn btn-outline-danger'>
                                        <b>刪除片單</b>
                                    </button></a>
                                </td>
                            </tr>
                    ...
                    ?>
                        ...
                        >
                            ...
                            <tbody>
                                <?php
                                    $result = mysqli_query($conn, "SELECT * FROM movie JOIN listm ON listm.m_id = movie.m_id WHERE listm.l_id = '$l_id'");
                                        ...
                                        echo"
                                            ...
                                            <tr>
                                                ...
                                                <td style='width:100px;'>
                                                    <a href='./dblinks/delete-movieList.php?method=delete&m_id=",$row['m_id'],"&l_id=".$l_id."'>
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                <?php
                                    $result = mysqli_query($conn, "SELECT * FROM movie WHERE m_id NOT IN (
                                                                    SELECT m_id FROM listm WHERE l_id = '$l_id'
                                    )");
                                    while($row = mysqli_fetch_assoc($result)){
                                        echo"
