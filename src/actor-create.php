                            ...
                            <input type=hidden name="dbaction" value="insert">
                                ...
                                >
                                    ...
                                    <tbody>
                                        ...
                                        <td></td>
                                        <td>
                                            <input type=text name="a_name" style="width:90px; margin-bottom: 0px;" placeholder="演員名" required maxlength=30>
                                        </td>
                                        <td align="center"><input type=text name="a_pic" placeholder="圖片網址" required maxlength=300 style="margin-bottom: 0px;"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style='width: 115px;'>
                                                    <a href='./actor-update.php?method=update&a_id=",$row['a_id'],"'>
                                                        <img src='./img/edit.png'style='width: 25px; margin: 8px;'>
                                                    </a>&nbsp
